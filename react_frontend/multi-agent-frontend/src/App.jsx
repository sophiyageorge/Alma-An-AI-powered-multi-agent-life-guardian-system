...
const [isAuthOpen, setIsAuthOpen] = useState(false);
  return (
    ...
    color: "white",
    padding: "10px"
  }} onClick={() => setIsAuthOpen(true)}>Login</button>
  </div>
      <AuthModel
  isOpen={isAuthOpen}
  onClose={() => setIsAuthOpen(false)}
...
{isAuthenticated && <p>Welcome, you are logged in!</p>}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6">
          ...
          {/* <div
            className={`group relative overflow-hidden bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6 hover:border-cyan-500/40 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 hover:scale-[1.02] ${mounted ? "opacity-100 translate-x-0" : "opacity-0 translate-x-20"
              }`}
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <div className="bg-white/5 rounded-lg p-3 hover:bg-white/10 transition-colors duration-300">
                  <div className="text-xs text-gray-400 mb-1">Resting</div>
                  <div className="text-sm font-semibold text-white">68 bpm</div>
                </div>
                <div className="bg-white/5 rounded-lg p-3 hover:bg-white/10 transition-colors duration-300">
                  <div className="text-xs text-gray-400 mb-1">Peak Today</div>
        ...
        >
          {/* Heart Rate Trend */}
           <HeartRateChart />
          {/* <div className="relative overflow-hidden bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6 hover:border-cyan-500/40 hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-500">
            <div className="absolute top-0 left-0 w-32 h-32 bg-cyan-500/10 rounded-full -ml-16 -mt-16 animate-pulse"></div>
            <div className="relative">
              <div className="flex items-center justify-between mb-4">
        ...
        >
          ...
          <div className="relative">
            <div className="flex flex-wrap items-center gap-3 mb-6">
              <div className="p-3 bg-amber-500/20 rounded-xl hover:scale-110 transition-transform duration-300">
                <Apple className="w-6 h-6 text-amber-400" />
              </div>
              <h2 className="text-xl font-bold text-white">
                Today's Meal Plan
              </h2>
              <div className="ml-auto flex items-center gap-1 px-3 py-1 bg-amber-500/20 border border-amber-500/30 rounded-full hover:bg-amber-500/30 transition-colors duration-300">
                <Sparkles className="w-3 h-3 text-amber-400 animate-pulse" />
                <span className="text-xs text-amber-300">AI Personalized</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {meals.map((meal, idx) => (
                <div
                  key={idx}
                  onClick={() => setSelectedMeal(idx === selectedMeal ? null : idx)}
                  className={`group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:border-amber-500/30 transition-all duration-300 cursor-pointer hover:scale-105 hover:shadow-xl hover:shadow-amber-500/20 ${selectedMeal === idx ? "ring-2 ring-amber-500/50 scale-105" : ""
                    }`}
                  style={{ transitionDelay: `${600 + idx * 100}ms` }}
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-amber-500/0 via-amber-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></div>
                  <div className="relative">
                    <div className="text-4xl mb-3 transform group-hover:scale-110 transition-transform duration-300">
                      {meal.icon}
                    </div>
                    <div className="font-semibold text-white mb-1 group-hover:text-amber-300 transition-colors duration-300">
                      {meal.name}
                    </div>
                    ...
                    {/* Expandable Macros */}
                    <div
                      className={`overflow-hidden transition-all duration-300 ${selectedMeal === idx ? "max-h-20 opacity-100" : "max-h-0 opacity-0"
                        }`}
                    >
                      <div className="pt-3 border-t border-white/10 grid grid-cols-3 gap-2 text-xs">
                        <div className="text-center">
                          <div className="text-cyan-400 font-semibold">{meal.macros.protein}g</div>
                          <div className="text-gray-400">Protein</div>
                        </div>
                        <div className="text-center">
                          <div className="text-amber-400 font-semibold">{meal.macros.carbs}g</div>
                          <div className="text-gray-400">Carbs</div>
                        </div>
                        <div className="text-center">
                          <div className="text-rose-400 font-semibold">{meal.macros.fats}g</div>
