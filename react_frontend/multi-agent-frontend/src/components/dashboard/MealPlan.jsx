...
// import { approveMealPlan } from "../../services/api";
...
//         setSelectedDay(Object.keys(parsed)[0]);
//       } catch (error) {
//         console.error(error);
//       }
//     };
...
//                   {meal.macros.protein}g<br />Protein
//                 </div>
//                 <div className="text-amber-400 text-center">
//                   {meal.macros.carbs}g<br />Carbs
//                 </div>
//                 <div className="text-rose-400 text-center">
//                   {meal.macros.fats}g<br />Fats
//                 </div>
//               </div>
//             </div>
//           </div>
